...
class AuthService {
  ...
  Future<int?> requestOtp(String phone) async {
    final data = await _client.post('/auth/otp/request', body: {'phone': phone, 'role': 'driver'});
    return (data as Map<String, dynamic>)['resentAfter'] as int?;
  }

  Future<Map<String, dynamic>> verifyOtp(String phone, String code) async {
    final data = await _client.post('/auth/otp/verify', body: {'phone': phone, 'code': code, 'role': 'driver'});
    final map = data as Map<String, dynamic>;
    await _storage.write(key: 'authToken', value: map['token'] as String);
    await _storage.write(key: 'driverPhone', value: phone);
    return map;
  }
