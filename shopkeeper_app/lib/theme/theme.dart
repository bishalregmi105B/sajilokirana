...
class AppTheme {
  ...
  static ThemeData get light => ThemeData(
    ...
    colorScheme: const ColorScheme.light(
      ...
      onPrimary: AppColors.surface, onSurface: AppColors.textPrimary,
    ),
    textTheme: GoogleFonts.interTextTheme(),
    appBarTheme: AppBarTheme(
      backgroundColor: AppColors.surface, foregroundColor: AppColors.textPrimary,
      elevation: 0, centerTitle: false,
      titleTextStyle: GoogleFonts.lora(fontSize: 18, fontWeight: FontWeight.w600, color: AppColors.textPrimary),
    ),
